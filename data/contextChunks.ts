...
export const knowledgeChunks = [
  ...
  {
    source: "stack",
    content: `Emmanuel's backend stack: Node.js, Express.js, Supabase PostgreSQL, Prisma ORM, Firebase (Firestore, Auth, Cloud Messaging), Resend, UploadThing, NextAuth.js, Docker, docker-compose, Server-Sent Events (SSE), REST APIs.`,
  },
  {
    source: "stack",
