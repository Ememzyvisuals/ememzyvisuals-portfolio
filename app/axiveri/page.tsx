...
const orgSchema = {
  ...
  description: "Axiveri is an African AI research initiative building open-source language models including the Africlaude series.",
};
      ...
      <div className="min-h-screen bg-background">
        ...
        <section className="container-padded pt-32 pb-20">
          <div className="max-w-4xl">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-border text-xs font-bold uppercase tracking-widest text-muted-foreground mb-8">
              African AI Research
            </div>
            <h1
          ...
          <div className="grid md:grid-cols-2 gap-16 items-start">
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed text-lg mb-4">
                Africa has over 2,000 languages and 1.4 billion people. The majority of frontier AI
                models are built on Western data, in Western languages, for Western contexts.
              </p>
              <p className="text-muted-foreground leading-relaxed text-lg mb-4">
              ...
              <p className="text-muted-foreground leading-relaxed text-lg">
                Our first model series, Africlaude, is open-source and freely available. Research,
                fine-tuning, and commercial use are welcome.
              </p>
            </div>
            ...
            <div className="flex items-start justify-between gap-4">
              <div className="space-y-3">
                <div className="flex items-center gap-3">
                  <span className="text-xs font-extrabold px-2.5 py-1 rounded-full bg-foreground text-background uppercase tracking-widest">
                    Live
                  </span>
                  <span className="text-xs text-muted-foreground font-bold uppercase tracking-widest">Series 1</span>
                </div>
                <h3
                ...
                <div className="flex flex-wrap gap-2 pt-2">
                  {["7B Parameters", "Open Source", "HuggingFace", "African AI"].map((tag) => (
                    <span key={tag} className="text-[10px] font-bold px-3 py-1 rounded-full border border-border text-muted-foreground uppercase tracking-wider">
                      {tag}
                    </span>
                  ))}
                </div>
              </div>
              <div className="flex-shrink-0 w-12 h-12 rounded-full border border-border flex items-center justify-center group-hover:bg-foreground group-hover:text-background transition-colors">
                <ArrowRight size={18} />
              </div>
            </div>
          </Link>
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-16">
            ...
            <div className="p-6 rounded-3xl border border-border bg-card space-y-4">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                Send crypto directly to fund model training and compute. Every amount helps.
              </p>
              <div className="space-y-3">
                {wallets.map((w, i) => (
                  <div key={i} className="space-y-1">
                    ...
                    <button
                      ...
                      title="Click to copy"
                      className="w-full text-left text-[10px] font-mono text-muted-foreground bg-muted px-3 py-2 rounded-xl truncate hover:text-foreground transition-colors cursor-copy"
                    >
                      {w.address}
                    </button>
                  </div>
            ...
            <div className="p-6 rounded-3xl border-2 border-foreground bg-foreground text-background space-y-4">
              ...
              <p className="text-sm opacity-70 leading-relaxed">
                Serious investment or grant inquiries for Axiveri&apos;s continued
