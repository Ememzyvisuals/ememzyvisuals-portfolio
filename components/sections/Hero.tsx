    ...
    <section className="relative flex flex-col items-center justify-center text-center px-5 pt-24 pb-10 md:pt-32 md:pb-16 min-h-[85vh]">
      <div className="relative z-10 max-w-2xl mx-auto space-y-6">
        ...
        <motion.div
          ...
          className="space-y-0"
        >
          <h1 className="font-extrabold text-foreground block"
        ...
        >
          Focused on building scalable web applications and AI systems
          that solve real-life problems and deliver measurable results.
        </motion.p>
